...
const UI = {
  fr: {
    ...
    "mode.learn.tag": "11 scénarios · 66 missions",
    ...
    "l.hero.sub": "Pas un PDF, pas une liste de commandes à réciter. Un vrai mini-shell simulé — pipes, variables, scripts — avec 66 missions scénarisées, des combats de boss, et une Ceinture Noire à décrocher.",
    ...
    "l.stats.missions": "<b>66</b> missions",
    ...
    "l.mode.learn.d": "11 scénarios réalistes, 66 missions : leçon → exercice → explication. Indices à 3 paliers pour ne jamais rester bloqué.",
    "l.mode.learn.tag": "11 scénarios · 66 missions",
  ...
  en: {
    ...
    "mode.learn.tag": "11 scenarios · 66 missions",
    ...
    "l.hero.sub": "Not a PDF, not a list of commands to recite. A real simulated mini-shell — pipes, variables, scripts — with 66 scripted missions, boss fights, and a Black Belt to earn.",
    ...
    "l.mode.learn.d": "11 realistic scenarios, 66 missions: lesson → exercise → explanation. 3-tier hints so you're never stuck.",
    "l.mode.learn.tag": "11 scenarios · 66 missions",
