...
| Mode | Description |
|---|---|
| 📖 **Apprendre** | 8 scénarios réalistes, 48 missions : leçon → exercice → explication. Quiz de fin de chapitre + révision espacée. Du premier `ls` jusqu'à la réponse à incident, l'**automatisation par scripts** et le **versioning avec Git**. |
